...
import Pay2Table from "./table_pay/pay2.tsx";

export default class Pay2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pay1_money: "",
              ...
              >
                <MDBRow style={{ color: "#2f2f4a", padding: 5 }}>
                  <MDBCol
                    ...
                    style={{ padding: 0, paddingTop: 10 }}
                  >
                    <h5 style={{ color: "green", fontSize: 14 }}>ชื่อธนาคาร</h5>
                  </MDBCol>
                  <MDBCol md="7">
                    <input
                      type="text"
