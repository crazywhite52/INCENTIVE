...
class Pay4 extends React.PureComponent<any, IGridProps> {
  ...
  public render() {
    ...
    const columns: any =[
        ...
        { text: 'ธนาคาร', pinned: true, editable: false,  datafield: 'paycontact', cellsalign: 'center',align: 'center', width: '35%' },
